...
function isValid(form, input, inputErrorClass, errorClass) {
    ...
    if (input.validity.patternMismatch) {
        showInputError(input, inputErrorClass, errorClass, input.dataset.errorMsg, errorElement);
    } else {
        if (input.validity.valid) {
            hideInputError(input, inputErrorClass, errorClass, errorElement)
        } else {
            showInputError(input, inputErrorClass, errorClass, input.validationMessage, errorElement);
        }
    }
}
...
function showInputError(input, inputErrorClass, errorClass, errorMessage, errorElement) {
